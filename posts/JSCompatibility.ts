...
<br>
하위 호환성이란, 단 한번이라도 유효한 JS 문법이라고 인정되면, 그 이후 업데이트가 있다 하더라도 절대 그 유효성이 깨지지 않는다는 의미이다.<br>
(물론 예외는 있습니다, 아주 드물지만요)
<br>
그 반대로 상위호환성이 보장되는 언어였다면, 구형 JS엔진에서 새로 추가된 JS문법이 동작되어야 하는데, 그렇지 않죠.<br>
그렇기 때문에 상위호화넝이 보장하지 않는다고 하는 겁니다.<br>
<br>
그런데 개발자들은 이런 간극을 줄이기 위해서 노력하고 있습니다.<br>
<br>
