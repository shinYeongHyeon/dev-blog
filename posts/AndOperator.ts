...
~끗!~`,
    listContents: `자바스크립트 논리 연산자 &&를 if 조건문이나 삼항연산자 대신 사용해 조건이 참일 때만 함수를 실행하고 코드를 짧게 유지하는 방법을 예제 코드로 알아본다.`,
    datetime: '2021년 02월 08일 00시 55분',
    tags: [ETC],
    keywords: ['javascript', '자바스크립트', '&& 연산자', 'AND 연산자', '논리 연산자', '조건문', '삼항연산자'],
};
