...
그 의미를 그대로 가질 수 없는 열은 다른 열과 조합으로 의미를 가지게 하는 것이 좋은 것 같다.`,
    listContents: `데이터베이스에서 NULL 을 습관적으로 쓰는 것에 대한 고찰. NULL 은 값이 없는지 안 들어온 건지 오류인지 해석이 모호하고, 연산 결과도 NULL 이 되며 DBMS 마다 취급이 달라 가급적 지양하자는 생각을 정리했다.`,
    datetime: '2021년 01월 30일 14시 13분',
    tags: [DATABASE],
    keywords: ['NULL', '데이터베이스', 'DB NULL', 'NULL 연산', 'DBMS', '데이터 모델링', 'NULL 지양', '기본값'],
};
