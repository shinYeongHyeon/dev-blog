...
export const metadata: Metadata = {
  title: '프로필',
  description: 'Den Shin의 프로필과 경력 사항을 확인하세요.',
  openGraph: {
    title: '프로필 | Den`s Dev Blog',
    description: 'Den Shin의 프로필과 경력 사항을 확인하세요.',
  },
}
...
export default function DenShinDev() {
  const latestPostComponents = allPosts
    .slice(0, RECENT_STANDARD)
    .map(({ path, title, listContents, datetime, tags }) => (
